        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="product product-list-wrapper">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-desc">
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. <a href="https://www.portotheme.com/html/porto/demo-5/prorduct.php">Learn More</a></p>
                ...
                <div class="product product-list-wrapper">
                    ...
                    <div class="product-details">
                        <h2 class="product-title">
                            <a href="product.php">Black Slippers</a>
                        </h2>
                        <div class="ratings-container">
                            <div class="product-ratings">
                ...
                <div class="product product-list-wrapper">
                    ...
                    <div class="product-details">
                        <h2 class="product-title">
                            <a href="product.php">Dean Cap Grey</a>
                        </h2>
                        <div class="ratings-container">
                            <div class="product-ratings">
                ...
                <div class="product product-list-wrapper">
                    ...
                    <div class="product-details">
                        <h2 class="product-title">
                            <a href="product.php">Classic Glasses</a>
                        </h2>
                        <div class="ratings-container">
                            <div class="product-ratings">
                ...
                <div class="product product-list-wrapper">
                    ...
                    <div class="product-details">
                        <h2 class="product-title">
                            <a href="product.php">Shoulder Bag</a>
                        </h2>
                        <div class="ratings-container">
                            <div class="product-ratings">
