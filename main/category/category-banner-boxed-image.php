<main class="main">
    ...
    <nav aria-label="breadcrumb" class="top-nav breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb mt-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Boxed Image Banner</li>
            </ol>
        </div><!-- End .container -->
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                <div class="banner banner-cat mb-2" style="background-image: url('assets/images/banners/banner-top.jpg');">
                    ...
                    <div class="col-6 col-md-4">
                        <div class="product">
                            ...
                            <div class="product-details">
                                ...
                                <h2 class="product-title">
                                    <a href="product.php">Blue Jacket</a>
                                </h2>
                                <div class="price-box">
